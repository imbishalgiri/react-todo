...
const CalculatedDisplay = ({providedClass, categoryName, amount, pClass, percentage}) => {

    const percentageSpan = percentage ? <Percentbox providedClass = {pClass} providedValue = {percentage}/> : null;
